...
- (id)initWithNibName:(NSString *)nibNameOrNil bundle:(NSBundle *)nibBundleOrNil
{
    ...
    if (self) {
        ...
        LabelData *lbl_1 = [LabelDataFactory createLabelWithText:@"Geef de iphone door naar de persoon \nhet dichts bij jou!" width:180 height:65 xPos:102 yPos:120];
        LabelData *lbl_2 = [LabelDataFactory createLabelWithText:@"Ga naar een speeltuin of park in de buurt." width:252 height:50 xPos:27 yPos:298];
        LabelData *lbl_3 = [LabelDataFactory createLabelWithText:@"Kies een speeltuig uit dat je op een leuke manier in beweging brengt." width:186 height:90 xPos:99 yPos:lbl_2.yPos + lbl_2.height + 21];
        ...
        LabelData *lbl_5 = [LabelDataFactory createLabelWithText:@"Tijdens het filmen worden \nje bewegingen geregistreerd." width:255 height:64 xPos:56 yPos:670];
        LabelData *lbl_6 = [LabelDataFactory createLabelWithText:@"Je kan jezelf filmen, of de lucht, of je vrienden die je duwen op de schommel,..." width:278 height:71 xPos:25 yPos:792];
        LabelData *lbl_7 = [LabelDataFactory createLabelWithText:@"Wees origineel!" width:128 height:71 xPos:105 yPos:lbl_6.yPos+lbl_6.height+2];
        LabelData *lbl_8 = [LabelDataFactory createLabelWithText:@"Draai de iPhone om te beginnen" width:262 height:30 xPos:25 yPos:lbl_7.yPos+lbl_7.height+40];
